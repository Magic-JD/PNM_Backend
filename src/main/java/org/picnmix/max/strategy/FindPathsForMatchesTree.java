...
public class FindPathsForMatchesTree implements FindPathsForMatches {
    ...
    private Stream<PathedMatch> getCombinationsForMatch(Map<Integer, List<String>> encodingToWords, Match match, Node node) {
        ...
        int sum = node.getValues(firstWord, secondWord).stream()
                ...
                .sum();
        return convertEncodedPathsToWordValues(encodingToWords, firstWord, secondWord, sum);
    }
